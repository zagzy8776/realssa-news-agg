...
int main() {
    ...
    // UPDATED: Notifications endpoint with proper CORS for Vercel
    ...
    // NEW: Handle OPTIONS preflight requests for CORS
    ...
    cout << "✅ CORS enabled for https://realssa.vercel.app" << endl;
